...
echo "╔════════════════════════════════════════════╗"
echo "║                Genie System                ║"
echo "║   Universal Save/Load Deployment Tool      ║"
echo "╚════════════════════════════════════════════╝"
echo -e "${RESET}"
...
if [ -f "./scripts/project-save.js" ] && [ -f "./scripts/project-load.js" ]; then
    echo -e "\n${GREEN}${BOLD}✅ Installation Complete!${RESET}"
    echo -e "\n${CYAN}Quick Test:${RESET}"
    echo -e "  Try running: ${BOLD}npm run save${RESET}"
    echo -e "  Then run: ${BOLD}npm run load${RESET}"
    echo ""
    echo -e "${CYAN}Claude Quick Commands:${RESET}"
    echo -e "  Type ${BOLD}save${RESET} in Claude Code to save"
    echo -e "  Type ${BOLD}load${RESET} in Claude Code to load"
    echo ""
else
